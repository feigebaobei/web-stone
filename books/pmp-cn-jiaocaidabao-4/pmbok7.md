...
价值交付系统是组织内部环境的一部分。内部环境存在于更大的外部环境中。
```
  |-----------------------------------------------------------|
  | 外部环境                                                   |
  |                                                           |
...
### 组织治理系统
组织治理系统与价值交付系统协同运作。
组织治理系统提供一个整合结构。用于评估价值交付系统的变更/问题和风险。

### 与项目有关的职能
由人驱动项目交付。协调集体工作对于任何项目都至关重要。
每人或每组履行相关职能。
去中心化式的协调/集中化式的协调。
- 提供监督和协调。包括精心安排项目工作/评估/分析/监督/开展工作/改善成员的健康/安全/整体福祉。协调包括咨询管理层和业务单元领导的想法。推进项目实现/提高项目绩效或满足客户需要。包括协助进行商业分析/招标/合同谈判/商业认证开发。
- 提出目标和反馈。
- 引导和支持
- 开展工作并贡献洞察
- 运用专业知识
